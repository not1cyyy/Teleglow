...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Teleglow.TeleglowDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Teleglow.TeleglowDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"Teleglow.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"Teleglow Desktop/Teleglow.lnk"_q;
	const auto old = u"AyuGram Desktop/AyuGram.lnk"_q;
