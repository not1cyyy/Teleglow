#define MyAppShortName "Teleglow"
#define MyAppName "Teleglow Desktop"
#define MyAppPublisher "Radolyn Labs"
#define MyAppURL "https://github.com/not1cyyy/Teleglow"
#define MyAppExeName "Teleglow.exe"
...
UninstallDisplayIcon={app}\Teleglow.exe
Compression=lzma
...
[Files]
Source: "{#ReleasePath}\Teleglow.exe"; DestDir: "{app}"; Flags: ignoreversion
#if MyBuildTarget != "winarm"
